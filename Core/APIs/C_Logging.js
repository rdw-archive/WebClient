const C_Logging = {
	loggers: {},
	createLoggers() {
		this.loggers[LOG_LEVEL_NONE] = new Logger({
			[LOG_LEVEL_NONE]: true,
		});
		this.loggers[LOG_LEVEL_TEST] = new Logger({
			[LOG_LEVEL_TEST]: true,
		});
		this.loggers[LOG_LEVEL_DEBUG] = new Logger({
			[LOG_LEVEL_DEBUG]: true,
		});
		this.loggers[LOG_LEVEL_INFO] = new Logger({
			[LOG_LEVEL_INFO]: true,
		});
		this.loggers[LOG_LEVEL_NOTICE] = new Logger({
			[LOG_LEVEL_NOTICE]: true,
		});
		this.loggers[LOG_LEVEL_WARNING] = new Logger({
			[LOG_LEVEL_WARNING]: true,
		});
		this.loggers[LOG_LEVEL_CRITICAL] = new Logger({
			[LOG_LEVEL_CRITICAL]: true,
		});
		this.loggers[LOG_LEVEL_SERVER] = new Logger({
