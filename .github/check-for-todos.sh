...
NUMBER_OF_COMMITTED_TODOS=$(git diff | grep -o 'TODO' | wc -l)
NUMBER_OF_COMMITTED_TBDS=$(git diff | grep -o 'TBD' | wc -l)
NUMBER_OF_COMMITTED_WIPS=$(git diff | grep -o 'WIP' | wc -l)
NUMBER_OF_COMMITTED_FIXMES=$(git diff | grep -o 'FIXME' | wc -l)
NUMBER_OF_COMMITTED_HACKS=$(git diff | grep -o 'HACK' | wc -l)
