// Fake module stuff (CBA to learn how  to do this properly)
let exports = {
    PACKING_LOGIC: {
        MAX_EDGE: 1,
        MAX_AREA: 0,
...
class MaxRectsBin extends Bin {
    constructor(maxWidth = EDGE_MAX_VALUE, maxHeight = EDGE_MAX_VALUE, padding = 0, options = { smart: true, pot: true, square: true, allowRotation: false, tag: false, border: 0, logic: exports.PACKING_LOGIC.MAX_EDGE }) {
        super();
...
class MaxRectsPacker {
     ...
     */
    constructor(width = EDGE_MAX_VALUE, height = EDGE_MAX_VALUE, padding = 0, options = { smart: true, pot: true, square: false, allowRotation: false, tag: false, border: 0, logic: exports.PACKING_LOGIC.MAX_EDGE }) {
        this.width = width;
        this.height = height;
        this.padding = padding;
        this.options = options;
